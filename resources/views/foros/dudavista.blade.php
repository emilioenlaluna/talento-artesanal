            ...
            <div class="card-body">
                ...
                @else
                    <form action="{{ route('foros.escribir') }}" method="POST">
                        ...
                        <textarea type="text" name="mensaje" id="mensaje" class="form-control" placeholder="Comparte tu respuesta aqui"
                            required></textarea>
                        <div class="d-flex mt-3">
                            <button class="btn btn-outline-info  ms-auto" style="padding: 0.25em 1em; font-size: larger"
                                type="submit" id="button-addon2"> Enviar
                                Respuesta
                            </button>
                        </div>
                    </form>
